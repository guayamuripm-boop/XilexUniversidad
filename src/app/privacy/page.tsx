  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-emerald-50 dark:from-[#051817] dark:via-[#0B1F1E] dark:to-[#052826]">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Política de Privacidad</h1>

        <div className="prose dark:prose-invert max-w-none space-y-6 text-gray-700 dark:text-gray-300">
          <p><strong>Última actualización:</strong> 15 de julio de 2026</p>

          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">1. Información que recopilamos</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">2. Cómo usamos tu información</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>Para提供erte acceso a la plataforma y sus funciones.</li>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">3. Compartir información</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">4. Seguridad</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">7. Cambios en esta política</h2>
